...
<p> 
<img src='../imagenes/tortilladeclaras.png' align='right'>
...
<br>
<input type='checkbox' name='ingrediente1' id='ingrediente1'>Picates(+10$)
<br>
<input type='checkbox' name='ingrediente2' id='ingrediente1'>Caldos(+10$)
<br>
<input type='checkbox' name='ingrediente3' id='ingrediente1'>Quesos(+15$)
<br>
<input type='checkbox' name='ingrediente4' id='ingrediente1'>Picadillos(+15$)
<br>
<input type='checkbox' name='ingrediente5' id='ingrediente1'>Condimentos(+20$)
<br>
<br>
Cantidad:::::::::::::::::::::::::::::::::::::::::
