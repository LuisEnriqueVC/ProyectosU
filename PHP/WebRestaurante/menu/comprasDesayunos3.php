...
<p> 
<img src='../imagenes/molletesconchorizo.png' align='right'>
...
<br>
<input type='checkbox' name='ingrediente1' id='ingrediente1'>Salsas(+10$)
<br>
<input type='checkbox' name='ingrediente2' id='ingrediente1'>Condimentos(+10$)
<br>
<input type='checkbox' name='ingrediente3' id='ingrediente1'>Clasiados(+15$)
<br>
<input type='checkbox' name='ingrediente4' id='ingrediente1'>Bebidas(+15$)
<br>
<input type='checkbox' name='ingrediente5' id='ingrediente1'>Chiles(+20$)
<br>
<br>
Cantidad:::::::::::::::::::::::::::::::::::::::::
