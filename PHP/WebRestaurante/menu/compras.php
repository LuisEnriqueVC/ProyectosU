...
$var_consulta= "select * from desayunos where idDesayuno=$codigo";
...
<p> 
<img src='../imagenes/hotcakes.png' align='right'>
...
<br>
<input type='checkbox' name='ingrediente1' id='ingrediente1'>Miel(+10$)
<br>
<input type='checkbox' name='ingrediente2' id='ingrediente1'>Mantequilla(+10$)
<br>
<input type='checkbox' name='ingrediente3' id='ingrediente1'>Mermelada(+15$)
<br>
<input type='checkbox' name='ingrediente4' id='ingrediente1'>Lechera(+15$)
<br>
<input type='checkbox' name='ingrediente5' id='ingrediente1'>Chispas de chocolate o frutas(+20$)
<br>
<br>
Cantidad:::::::::::::::::::::::::::::::::::::::::
