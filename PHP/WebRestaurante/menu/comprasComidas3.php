...
$var_consulta= "select * from comidas where idComidas=$codigo";
...
<p> 
<img src='../imagenes/especialidades-mexicanas-enchiladas-de-mole.png' align='right'>
...
<br>
<input type='checkbox' name='ingrediente1' id='ingrediente1'>Picantes(+10$)
<br>
<input type='checkbox' name='ingrediente2' id='ingrediente1'>Picadillos(+10$)
<br>
<input type='checkbox' name='ingrediente3' id='ingrediente1'>Quesos(+15$)
<br>
<input type='checkbox' name='ingrediente4' id='ingrediente1'>Papas(+15$)
<br>
<input type='checkbox' name='ingrediente5' id='ingrediente1'>Cremas(+20$)
<br>
<br>
Cantidad:::::::::::::::::::::::::::::::::::::::::
