...
<p> 
<img src='../imagenes/champinones.png' align='right'>
...
<br>
<input type='checkbox' name='ingrediente1' id='ingrediente1'>Picadillos(+10$)
<br>
<input type='checkbox' name='ingrediente2' id='ingrediente1'>Quesos(+10$)
<br>
<input type='checkbox' name='ingrediente3' id='ingrediente1'>Caldos(+15$)
<br>
<input type='checkbox' name='ingrediente4' id='ingrediente1'>Picantes(+15$)
<br>
<input type='checkbox' name='ingrediente5' id='ingrediente1'>Papas(+20$)
<br>
<br>
Cantidad:::::::::::::::::::::::::::::::::::::::::
