<%-- 
    ...
    Created on : 23/03/2022, 08:24:09 AM
    Author     : SALA 2-05
--%>
...
<html>
    <head>
        ...
        <title>Lista General Consulta</title>
    </head>
    <body>
            ...
            <div class="card boarder-info">
                ...
                <div class="card-body" id="tab">
                    ...
                    <table class="table table-hover">
                        <thead class="letras">
                            <tr>
                                <th>Codigo de la Consulta</th>
                                <th>Titulo del Libro</th>
                                <th>Fecha del Prestamo</th>
                                <th>Hora del Prestamo</th>
                                <th>Fecha Estimada Devoluciòn</th>
                                <th>Seccion tomada del Libro</th>
                                <th>Genero del Libro</th>
                                <th>Se presto?</th>
                                <th>Estado Devoluciòn</th>
                                <th>Empleado Realizo Consulta</th>
                                <th>Visitante Realizo Consulta</th>
                            ...
                            <c:forEach var="dato" items="${lista}">
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <a href="GeneraQRConsulta.htm?idConsulta=${dato.idConsulta}" class="btn btn-success">QR</a>
                                    </td>
                                </tr>
                            </c:forEach> 
                        </tbody>
