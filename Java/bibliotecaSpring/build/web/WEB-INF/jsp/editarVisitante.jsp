            ...
            <div class="card boarder-info">
                ...
                <div class="card-body" id="tab">
                    <form method="POST">
                        ...
                        <input type = "text" name="apellidoP" class="form-control" value="${lista[0].apellidoP}" required="true" placeholder="Apellido paterno"  style="background-color: #a9d6e5;"/>
                        <label>Apellido materno</label>
                        <input type = "text" name="apellidoM" class="form-control" value="${lista[0].apellidoM}" required="true" placeholder="Apellido materno"  style="background-color: #a9d6e5;"/>
                        <label>Ocupacion</label>
                        <input type = "text" name="ocupacion" class="form-control" value="${lista[0].ocupacion}" required="true" placeholder="Ocupacion"  style="background-color: #a9d6e5;"/>
                        <label>fecha de la Visita</label>
                        <input type = "date" name="fechaVisita" class="form-control" value="${lista[0].fechaVisita}" required="true" placeholder="Fecha de visita" style="background-color: #a9d6e5;"/>
                        <label>Hora  de entrada</label>
                        <input type = "time" name="horaEntrada" class="form-control" value="${lista[0].horaEntrada}"required="true" placeholder="Hora entrada"  style="background-color: #a9d6e5;"/>
                        <label>Hora de la salida</label>
                        <input type = "time" name="horaSalida" class="form-control" value="${lista[0].horaSalida}"required="true" placeholder="Hora salida"  style="background-color: #a9d6e5;"/>
                        <label>Motivo de la visita</label>
                        <input type = "text" name="motivoVisita" class="form-control" value="${lista[0].motivoVisita}"required="true" placeholder="Motivo visita" style="background-color: #a9d6e5;"/>
                        <label>Numero de la afiliacion</label>
                        <input type = "text" name="numeroAfiliacion" class="form-control" value="${lista[0].numeroAfiliacion}"required="true" placeholder="Numero afiliacion"  style="background-color: #a9d6e5;" size="5" maxlength="5" minlength="5"/>
