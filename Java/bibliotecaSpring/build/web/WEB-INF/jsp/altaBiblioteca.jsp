            ...
            <div class="card boarder-info">
                ...
                <div class="card-body" id="tab">
                    <form method="POST">
                        ...
                        <input type = "number" min="1000000000" max="9999999999" name="telefono" class="form-control" required="true" placeholder="Telefono" style="background-color: #a9d6e5;"/>
                        <label>Correo</label>
                        <input type = "text" name="correo" class="form-control" required="true" placeholder="Correo" style="background-color: #a9d6e5;"/>
                        <label>Clave de Trabajo</label>
                        <input type = "text" name="claveTrabajo" class="form-control" required="true" maxlength="10" placeholder="Clave de trabajo" style="background-color: #a9d6e5;" size="10" maxlength="10" minlength="10"/>
                        <br>
